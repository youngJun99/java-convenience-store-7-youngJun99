...
class PromotionImplTest {
    ...
    void promotionLogicTest1() {
        ...
        Purchase purchase = promotionTwoPlusOne.checkRequest("콜라", 10, 7);
    ...
    void promotionLogicTest2() {
        ...
        Purchase purchase = promotionTwoPlusOne.checkRequest("콜라", 6, 6);
        assertThat(purchase).isEqualTo(answer);
    }
    ...
    void promotionLogicTest3() {
        ...
        Purchase purchase = promotionTwoPlusOne.checkRequest("콜라", 5, 6);
        assertThat(purchase).isEqualTo(answer);
    }
    ...
    void promotionLogicTest4() {
        ...
        Purchase purchase = promotionTwoPlusOne.checkRequest("콜라", 4, 6);
        assertThat(purchase).isEqualTo(answer);
    }
    ...
    void promotionLogicTest5() {
        Purchase answer = new Purchase("콜라", false, 5, 0, 1);
        Purchase purchase = promotionOnePlusOne.checkRequest("콜라", 5, 6);
        assertThat(purchase).isEqualTo(answer);
    }
    ...
    void promotionLogicTest6() {
        Purchase answer = new Purchase("콜라", true, 6, 0, 0);
        Purchase purchase = promotionOnePlusOne.checkRequest("콜라", 6, 6);
        assertThat(purchase).isEqualTo(answer);
    }
